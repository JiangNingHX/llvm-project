 ...
 *
 * @return Result as nest_long_t
 * @note [-1/2, 1/2) -> 0 and in general [ (2n-1)/2, (2n+1)/2 ) -> n
 * @see dround
 */
nest_long_t ld_round( double );
 ...
 */
nest_long_t mod_inverse( nest_long_t a, nest_long_t m );
 ...
 */
size_t first_index( nest_long_t period, nest_long_t phase0, nest_long_t step, nest_long_t phase );
