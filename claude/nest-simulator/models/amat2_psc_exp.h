...
=========== ======= ===========================================================
 ...
 alpha_2    mV      Amplitude of nest_long_t time threshold adaption [3, eqs 2-3]
...
private:
  ...
  struct Parameters_
  {
    ...
    /** Short and nest_long_t time constant of adaptive threshold in ms. */
    double tau_1_;
    double tau_2_;
  ...
  struct State_
  {
    ...
    double V_th_1_;   //!< short time adaptive threshold (related to tau_1_),
                      //!< variable 4
    double V_th_2_;   //!< nest_long_t time adaptive threshold (related to tau_2_),
                      //!< variable 5
