 ...
 * ---------------------------------------------------------------- */
void
aeif_cond_alpha_multisynapse::update( Time const& origin, const nest_long_t from, const nest_long_t to )
{
  assert( State_::V_M == 0 );

  for ( nest_long_t lag = from; lag < to; ++lag ) // proceed by stepsize B_.step_
  {
